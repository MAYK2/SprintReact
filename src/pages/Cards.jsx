...
const Cards = () => {
  ...
  useEffect(() => {
    const fetchCards = async () => {
      try {
        ...
        console.log('Response from fetchCards:', response.data);
  ...
  const creditCards = Array.isArray(cards) ? cards.filter(card => card.type === 'CREDIT') : [];
  const debitCards = Array.isArray(cards) ? cards.filter(card => card.type === 'DEBIT') : [];
